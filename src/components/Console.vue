<template>
  <div class="console">
    ...
    <div v-if="open" class="text">
      ...
      <br> 2.5.7 :001 > <span class="text-success"> {{ consoleQuestions.myNameAndAGe }} </span> <span class="text-primary">= </span> <span class="orange">'Hammayoun Safi',</span> <span class="text-warning">{{myAge}}</span>
